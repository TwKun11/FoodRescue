...
const NAV_ITEMS = [
  ...
  { href: "/store/shop", label: "Cửa hàng", icon: ShopIcon, guide: "Quản lý hồ sơ người bán, thông tin cửa hàng, địa chỉ, giấy tờ xác minh và tài khoản nhận tiền." },
  ...
  { href: "/store/settings", label: "Cài đặt", icon: SettingsIcon, guide: "Điều chỉnh thiết lập vận hành và thông tin tài khoản người bán." },
];
  ...
  return (
    <aside className="w-48 shrink-0 bg-white border-r border-gray-200 min-h-screen flex flex-col">
      <div className="px-4 py-4 border-b border-gray-100">
        <Link href="/store" className="flex items-center gap-2.5" data-guide-title="Food Rescue Người bán" data-guide-text="Logo đưa người bán về trang Tổng quan cửa hàng.">
      ...
      <div className="px-3 pb-3">
        <Link
          ...
          data-guide-text="Chuyển khỏi kênh người bán để xem website dưới vai trò khách hàng/người mua."
      ...
      <div className="mx-3 bg-brand-bg border border-brand/50 rounded-xl p-3" data-guide-title="Gói cửa hàng" data-guide-text="Khu vực hiển thị gói dịch vụ hoặc hạn dùng của cửa hàng.">
