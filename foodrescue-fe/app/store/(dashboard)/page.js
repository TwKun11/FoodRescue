  ...
  return (
    <div className="p-6 sm:p-8 space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
          ...
          <Link href="/store/orders?status=pending" className="block">
            <StatCard
              ...
              icon={<IconAlert />}
              color="red"
              guideText="Số đơn đang chờ người bán xác nhận. Bấm vào thẻ để lọc các đơn cần xử lý trước."
            />
          </Link>
          ...
          <Link href="/store/products?filter=expiring" className="block">
            <StatCard
              ...
              icon={<IconClock />}
              color="orange"
              guideText="Số sản phẩm còn 0-3 ngày hạn dùng. Đây là nhóm người bán nên ưu tiên giảm giá hoặc xử lý nhanh."
            />
          </Link>
          ...
          <Link href="/store/products" className="block">
            <StatCard
              ...
              icon={<IconPackage />}
              color="blue"
              guideText="Tổng số sản phẩm hiện có trong cửa hàng. Bấm để mở trang quản lý sản phẩm."
            />
          </Link>
          ...
          <Link href="/store/stats" className="block">
            <StatCard
              ...
              icon={<IconCurrency />}
              color="green"
              guideText="Số dư người bán có thể đối soát hoặc yêu cầu chi trả. Số này lấy từ ví người bán sau khi hệ thống ghi nhận thanh toán."
            />
          </Link>
          ...
          <Link href="/store/stats" className="block">
            <StatCard
              ...
              icon={<IconCurrency />}
              color="blue"
              guideText="Khoản người bán dự kiến thực nhận sau khi trừ hoa hồng FoodRescue 5% trên tổng doanh thu."
            />
          </Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-6">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-5" data-guide-title="Ví người bán" data-guide-text="Khu vực này cho người bán xem nhanh số dư khả dụng, tiền đang chi và tổng tiền đã được ghi nhận vào ví.">
          <div className="flex items-center justify-between gap-4">
            <div>
              <h2 className="font-semibold text-gray-900">Ví người bán</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col h-full" data-guide-title="Sản phẩm bán chạy nhất" data-guide-text="Các sản phẩm có số lượng bán tốt nhất. Người bán dùng khu vực này để quyết định nhập thêm, đẩy quảng cáo hoặc tạo ưu đãi tương tự.">
        ...
        {/* ── 2. Sản phẩm sắp hết hạn ── */}
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col h-full" data-guide-title="Sản phẩm sắp hết hạn" data-guide-text="Danh sách sản phẩm gần hết hạn dùng. Người bán nên xử lý sớm để giảm lãng phí và tránh khiếu nại.">
          <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            <div className="flex items-center gap-2">
        ...
        {/* ── 3. Đơn hàng gần nhất ── */}
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col h-full" data-guide-title="Đơn gần nhất" data-guide-text="Các đơn mới hoặc vừa cập nhật. Người bán có thể bấm vào từng đơn để xem chi tiết và xử lý trạng thái.">
          <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            <div className="flex items-center gap-2">
