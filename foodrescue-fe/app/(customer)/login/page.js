...
import { apiGoogleLogin, apiLogin, setAuthSession } from "@/lib/api";
...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) {
        toast.error(res.data?.message || "Đang nhập thất bại. Vui lòng kiểm tra lại thông tin.");
        return;
      }
  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="hidden lg:block relative overflow-hidden">
        <img src="/images/landingpage/landingpage.png" alt="" className="w-full h-full object-cover object-center" />
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-14 xl:px-20 text-white">
          <Link href="/" className="inline-flex items-center gap-3 mb-12 group w-fit">
            <span className="text-2xl font-extrabold tracking-tight group-hover:text-brand transition">
              Food Rescue
            </span>
          </Link>
      ...
      <div className="flex flex-col justify-center items-center px-6 py-12 bg-background">
        ...
        <div className="w-full max-w-sm">
          ...
          >
            <p className="text-center text-sm text-gray-500">Chưa có tài khoản? Đăng ký ngay</p>
